                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a href="<?php echo site_url('admin/manage_staff_user'); ?>">Manage Staff Users</a><span class="divider">&nbsp;</span></li>
                            ...
                            <div class="span12">
                                ...
                                <div class="widget">
                                    <div class="widget-title">
                                        <h4><i class="icon-reorder"></i>  <a href="<?php echo site_url('admin/manage_staff_user'); ?>">List Users</a> / Edit User</h4>
                                    </div>
                                    <div class="widget-body">
                                        <!-- BEGIN FORM-->
                                        <form action="<?php echo site_url(); ?>/admin/update_staff_user" class="form-horizontal" name="add_staff_user" id="add_staff_user" method="post">
