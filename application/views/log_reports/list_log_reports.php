              ...
              <div class="widget-body">
                <div class="portlet-body">
                  ...
                  <div style="width:100%;overflow: auto;overflow-y: hidden;;">
                    <br>  
                    <form name="list_reports" id="list_reports" method="get" action="<?php echo site_url(); ?>/log_reports/list_log_reports">
                      ...
                      <div style="float:left;" class="input" id="ui_date_picker_range_to">
                        &nbsp; to <input type="text" style="width:150px;" class="input-sm form-control" name="date_to" id="date_to" placeholder="to date" value="<?php if(isset($date_to)){ echo $date_to;} ?>"/>
                          ...
                          <div style="float:left;">&nbsp;
                            <select style="width:130px;" name="keyword">
                              <option value="">Select Keyword</option>
                              <option value="GOLD" <?php if(isset($keyword)){ if('GOLD'==$keyword){ echo "selected";} } ?> >GOLD</option>
                              <option value="ADD" <?php if(isset($keyword)){ if('ADD'==$keyword){ echo "selected";} } ?>  >ADD</option>
                            </select>
                          </div>

                          <div style="float:left;">&nbsp;
                            &nbsp; <input type="text" style="width:120px;" class="input-sm form-control" name="coupon" id="coupon" placeholder="Search Code" value="<?php if(isset($coupon)){ echo $coupon;} ?>"/>
                          </div>
                          ...
                          <table class="table table-striped table-hover table-bordered" id="table_without_pagination">
                            <thead>
                              <tr>
                                ...
                                <th style="color:#555;">Original Msg</th>
                                <th style="color:#555;">Processed Msg</th>
                              ...
                              if ($result['result']) {
                                foreach ($result['result'] as $val) {
                                  ...
                                  <tr class="">
                                    ...
                                    <td><?php echo wordwrap($val['original_msg'], 25, ' ', true); ?></td>
                                    <td><?php echo wordwrap($val['processed_msg'], 25 ,' ' , true); ?></td>
